...
const Tech = () => {
  return (
    ...
    <div className='grid grid-cols-5 grid-rows-2  gap-y-10 gap-x-9 mt-10 px-9 sm:px-28   '>
        ...
        <div className='flex flex-col justify-between items-center'><img alt='tsIcon' src={reactIcon} className='h-11'></img> <div className='text-sm sm:text-lg'>React Native</div></div>
        ...
        <div className='flex flex-col justify-between items-center'><img alt='tsIcon' src={firebase} className='h-11'></img> <div className='text-sm sm:text-lg'>Firebase</div></div>
